...
export function createDesertShrubConfig(position: Point, angle: number): EntityConfig {
   ...
   const hitbox = createHitbox(transformComponent, null, new CircularBox(position, new Point(0, 0), angle, 36), 1.5, HitboxCollisionType.soft, COLLISION_BITS.default, DEFAULT_COLLISION_MASK, []);
