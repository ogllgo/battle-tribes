...
export function createTumbleweedDeadConfig(position: Point, angle: number): EntityConfig {
   ...
   const hitbox = createHitbox(transformComponent, null, new CircularBox(position, new Point(0, 0), angle, 40), randFloat(0.19, 0.23), HitboxCollisionType.soft, COLLISION_BITS.default, DEFAULT_COLLISION_MASK, []);
