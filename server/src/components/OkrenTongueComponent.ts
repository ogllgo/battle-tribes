...
// const getTongueTip = (tongueTransformComponent: TransformComponent): Entity => {
//    const attachInfo = tongueTransformComponent.children[0] as EntityAttachInfo;
//    return attachInfo.attachedEntity;
// }
...
//    const newSegmentHitbox = segmentTransformComponent.hitboxes[0];
...
//       const partHitbox = partTransformComponent.hitboxes[0];
...
//    const tongueBaseHitbox = tongueBaseTransformComponent.hitboxes[0];
...
//          const nextBaseSegmentHitbox = nextBaseSegementTransformComponent.hitboxes[0];
