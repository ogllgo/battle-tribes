...
export function createTunnelConfig(position: Point, rotation: number, tribe: Tribe, material: BuildingMaterial): EntityParams {
   ...
   // Soft hitboxes
   const soft1 = createHitbox(hitboxLocalID++, null, new RectangularBox(position.copy(), new Point(-32 + HITBOX_WIDTH / 2, 0), rotation, HITBOX_WIDTH, HITBOX_HEIGHT), new Point(0, 0), new Point(0, 0), 1, HitboxCollisionType.soft, CollisionBit.default, DEFAULT_COLLISION_MASK, []);
   hitboxes.push(soft1);
   const soft2 = createHitbox(hitboxLocalID++, null, new RectangularBox(position.copy(), new Point(32 - HITBOX_WIDTH / 2, 0), rotation, HITBOX_WIDTH, HITBOX_HEIGHT), new Point(0, 0), new Point(0, 0), 1, HitboxCollisionType.soft, CollisionBit.default, DEFAULT_COLLISION_MASK, []);
   hitboxes.push(soft2);

   // Hard hitboxes
   const hard1 = createHitbox(hitboxLocalID++, null, new RectangularBox(position.copy(), new Point(-32.5 + THIN_HITBOX_WIDTH, 0), rotation, THIN_HITBOX_WIDTH, HITBOX_HEIGHT), new Point(0, 0), new Point(0, 0), 1, HitboxCollisionType.hard, CollisionBit.default, DEFAULT_COLLISION_MASK, []);
   hitboxes.push(hard1);
   const hard2 = createHitbox(hitboxLocalID++, null, new RectangularBox(position.copy(), new Point(32.5 - THIN_HITBOX_WIDTH, 0), rotation, THIN_HITBOX_WIDTH, HITBOX_HEIGHT), new Point(0, 0), new Point(0, 0), 1, HitboxCollisionType.hard, CollisionBit.default, DEFAULT_COLLISION_MASK, []);
   hitboxes.push(hard2);
